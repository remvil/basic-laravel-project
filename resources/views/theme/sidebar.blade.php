      ...
      <div class="nav accordion" id="accordionSidenav">
          ...
          <nav class="sidenav-menu-nested nav accordion" id="accordionSidenavPagesMenu">
            ...
            <div class="collapse" id="pagesCollapseAccount" data-bs-parent="#accordionSidenavPagesMenu">
              <nav class="sidenav-menu-nested nav">
                <a class="nav-link" href="acc-profile.html">Profile</a>
                <a class="nav-link" href="account-billing.html">Billing</a>
                <a class="nav-link" href="account-security.html">Security</a>
                <a class="nav-link" href="acc-notifications.html">Notifications</a>
              </nav>
            </div>
            ...
            <div class="collapse" id="pagesCollapseAuth" data-bs-parent="#accordionSidenavPagesMenu">
              <nav class="sidenav-menu-nested nav accordion" id="accordionSidenavPagesAuth">
                ...
                <a class="nav-link collapsed" href="javascript:void(0);" data-bs-toggle="collapse"
                  data-bs-target="#pagesCollapseAuthBasic" aria-expanded="false" aria-controls="pagesCollapseAuthBasic">
                  Basic
                  <div class="sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
                </a>
          ...
          <nav class="sidenav-menu-nested nav accordion" id="accordionSidenavAppsMenu">
            ...
            <div class="collapse" id="appsCollapseKnowledgeBase" data-bs-parent="#accordionSidenavAppsMenu">
              <nav class="sidenav-menu-nested nav">
                ...
                <a class="nav-link" href="knowledgebasehome2.html">Home 2</a>
            ...
            <div class="collapse" id="appsCollapseUserManagement" data-bs-parent="#accordionSidenavAppsMenu">
              <nav class="sidenav-menu-nested nav">
                <a class="nav-link" href="usr-mgmt-list.html">Users List</a>
                <a class="nav-link" href="usr-mgmt-edit-user.html">Edit User</a>
                <a class="nav-link" href="usr-mgmt-add-user.html">Add User</a>
                <a class="nav-link" href="usr-mgmt-groups-list.html">Groups List</a>
                <a class="nav-link" href="usr-mgmt-org-details.html">Organization Details</a>
              </nav>
            </div>
        ...
        <div class="collapse" id="collapseLayouts" data-bs-parent="#accordionSidenav">
          <nav class="sidenav-menu-nested nav accordion" id="accordionSidenavLayout">
            ...
            <a class="nav-link collapsed" href="javascript:void(0);" data-bs-toggle="collapse"
              data-bs-target="#collapseLayoutContainers" aria-expanded="false" aria-controls="collapseLayoutContainers">
              Container Options
              <div class="sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
            </a>
